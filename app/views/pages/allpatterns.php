  <div class="sg-info">               
    <div class="sg-about sg-section">
      ...
      <p>The patterns are stored as html files inside a directory based on their pattern type. That directory is located at /patterns..
  ...
  <div class="sg-pattern-styles">
    <h1 class="sg-h1">Components<small> - groups of molecules (and possibly atoms) joined together to form distinct section of an interface. In Atomic Design these are called Organisms.</small></h1>
    <?php //showMarkup('patterns'); ?>
    <?php echo $components; ?>
    </div><!--/.sg-pattern-styles-->
